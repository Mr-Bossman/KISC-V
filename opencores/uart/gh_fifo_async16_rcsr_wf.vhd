...
-----------------------------------------
	...
	n_add_WR <= std_logic_vector(unsigned(add_WR) + 1);
...
-----------------------------------------
	...
	n_add_RD <= std_logic_vector(unsigned(add_RD) + 1);
...
U5 : gh_gray2binary
	...
	c_add <= std_logic_vector(unsigned(c_add_WR) + unsigned(c_add_RD));
	
	q_full <= '0' when (iempty = '1') else
	          '0' when (unsigned(c_add(4 downto 2)) = 0) else
	          '1';
	
	h_full <= '0' when (iempty = '1') else
	          '0' when (unsigned(c_add(4 downto 3)) = 0) else
	          '1'; 
	
	a_full <= '0' when (iempty = '1') else
	          '0' when (unsigned(c_add(4 downto 1)) < 7) else
	          '1'; 
