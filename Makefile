...
system: src/system.S src/system.c src/system.lds
	...
	$(TARGET_LD) --gc-sections -T src/system.lds $(BUILD_DIR)/system_start.o $(BUILD_DIR)/bootloader.o $(BUILD_DIR)/system.o -o $(BUILD_DIR)/system.elf
...
testkern: all
	...
	truncate -s 3145728 $(BUILD_DIR)/test.bin # 0x1000000
